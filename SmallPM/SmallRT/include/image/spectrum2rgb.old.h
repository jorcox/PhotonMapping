...
static const double spectrum_RGB_step = (spectrum_rgb[1][0] - spectrum_rgb[0][0]);

double spectrum_R(double wavelength) { if ((1.e9*wavelength<spectrum_rgb[0][0])||(1.e9*wavelength>spectrum_rgb[spectrum_RGB_samples-1][0])) return 0.0;
					else return spectrum_rgb[(int)((1.e9*wavelength-spectrum_rgb[0][0])/spectrum_RGB_step)][1]; }
double spectrum_G(double wavelength) { if ((1.e9*wavelength<spectrum_rgb[0][0])||(1.e9*wavelength>spectrum_rgb[spectrum_RGB_samples-1][0])) return 0.0;
					else return spectrum_rgb[(int)((1.e9*wavelength-spectrum_rgb[0][0])/spectrum_RGB_step)][2]; }
double spectrum_B(double wavelength) { if ((1.e9*wavelength<spectrum_rgb[0][0])||(1.e9*wavelength>spectrum_rgb[spectrum_RGB_samples-1][0])) return 0.0;
					else return spectrum_rgb[(int)((1.e9*wavelength-spectrum_rgb[0][0])/spectrum_RGB_step)][3]; }
